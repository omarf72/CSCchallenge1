...
public class App {
    ...
    public static void simulate() {
     ...
     public static void handleSellOption() {
        ...
        // Assuming you have a method to display items for sale
        // For example:
        // sell.displayItemsForSale();
        String itemToSell = scan.next();
        // Assuming you have logic to handle selling items
        // For example:
        // sell.sellItem(itemToSell);
        System.out.println("Item sold successfully!");
        System.out.println("Would you like to go back to the main menu?");
        String goBackfromSell = scan.next();
        switch (goBackfromSell.toLowerCase()) {
            case "yes":
                simulate();
                break;
            case "no":
